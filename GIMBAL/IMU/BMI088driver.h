...
// 需手动修改
#if INFANTRY_ID == 0
#define GxOFFSET 0.00537235755     //0.00419966411f
#define GyOFFSET -0.00266989018   //-0.00283145835f
#define GzOFFSET -0.00129642151  //-0.000942402345f
#define gNORM 9.7399168
#elif INFANTRY_ID == 1
